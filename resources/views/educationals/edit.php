...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <section class="w3-padding">
            ...
            <form method="post" action="/console/educationals/edit/<?= $educational->id ?>" novalidate class="w3-margin-bottom">

                <?= csrf_field() ?>

                <div class="w3-margin-bottom">
                    <label for="credential">Credential:</label>
                    <input type="credential" name="credential" id="credential" value="<?= old('credential', $educational->credential) ?>" required>
                ...
                <div class="w3-margin-bottom">
                    ...
                    <input type="institution" name="institution" id="institution" value="<?= old('institution', $educational->institution) ?>">
                ...
                <div class="w3-margin-bottom">
                    ...
                    <input type="number" name="year" id="year" value="<?= old('year', $educational->year) ?>" required>
